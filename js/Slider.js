...
function initSlider(containerId,dataId,options)
{
    ...
    currentElement.elementsWidth = (containerWidth / currentElement.bucket) - 80;
    ...
    rightButton = rightButton + '<img src="./images/right_arrow.svg" height="35px" width="40px" >';
    ...
    leftButton = leftButton + '<img src="./images/left_arrow.svg" height="35px" width="40px" >';
    leftButton = leftButton + '</div>';
    $("#"+containerId).html(outerElement);
    $("#childContainer").html(leftButton);
    ...
    for(var index = 0 ; index < elements.length; index++){
        ...
        if(index>=options["itemCount"]){
            ...
            $(newElement).css({
                "width" : currentElement.elementsWidth
            });
        }
    ...
    if(!isListenerRegistered)
    {
        $("#"+containerId).on("click",".rightSliderBtn",function(){
            console.log("trigger right button");
